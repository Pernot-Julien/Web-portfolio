...
const FourthPage = () => {
  ...
  return (
    ...
    {/* Form */}
      ...
      {/* Google Frame */}
      <iframe className="h-[30vh] xl:block landscape:xl:w-[110vh] landscape:xl:h-[50vh] landscape:xl:mt-[10%] lg:hidden landscape:md:h-[70vh] landscape:md:w-[120vh] w-[80%] mx-auto h-[40vh] mt-[15%] landscape:h-[70vh] landscape:mt-[5%] rounded-[5%] landscape:rounded-[3%] md:w-[50vh] md:h-[40vh] md:mt-[8%] landscape:md:h-[40vh] landscape:xl:h-[65vh] landscape:xl:w-[110vh] landscape:xl:ml-[5%]"
